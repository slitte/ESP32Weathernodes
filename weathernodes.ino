...
const char* espName = "ESPxTest"; //set your own hostname
const char* mqtt_clientId = "ESPxTest"; //set your own hostname

// Available Topics for mqtt

const char* topic_data = "/data/nodes"; //set your own topic here
